...
#stacking the rasters for plotting & to make it easier to work with
...
#trying to brighten the image
#view raster, maximum digigtal is around 20000 so set scale to that
plotRGB(rgbS, scale=20000, stretch="lin")

#using map view to better look at the map with a contrast stretch
...
set.seed(12153)
#breaking each land class into training and test sets
#randomly select 
...
#view predictions
plot(rf_prediction)
#corresponding landclass numbers in the plot to the landclass name
landclass
#hard to predict with a continious raster legend, changing the color values
...
#plotting the prediction and hiding the legend
